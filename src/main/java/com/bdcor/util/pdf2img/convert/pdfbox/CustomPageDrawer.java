...
package com.bdcor.util.pdf2img.convert.pdfbox;
...
public class CustomPageDrawer
{
	...
	public static List<byte[]> convert(InputStream in) throws IOException{
        ...
        for(int i=0;i<pageSize;i++){
        	...
        	BufferedImage image = renderer.renderImage(i, 8, ImageType.RGB);
        	ImageIO.write(image, "JPG", outStream);
            //ImageIO.write(image, "PNG", new File("custom-render"+i+".png"));
        	
        	returnList.add(outStream.toByteArray());
        }
